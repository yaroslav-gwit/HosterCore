...
func main() {
	...
	r.HandleFunc("/api/v2/vm/settings/{vm_name}/{new_tag}", handlers.VmPostNewTag).Methods(http.MethodPost)
	...
	r.HandleFunc("/api/v2/vm/destroy/{vm_name}/{existing_tag}", handlers.VmDeleteExistingTag).Methods(http.MethodDelete)
	// Jails
